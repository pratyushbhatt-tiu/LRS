    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('masters.recording-purposes.store') }}">
                        @csrf
                        <div class="mb-4">
                        ...
                        <x-masters.form-actions :cancelRoute="route('masters.recording-purposes.index')" />
                    </form>
                </div>
            </div>
        </div>
